...
class clientes{
	public function adicionarCliente($dados){
		...
		$sql = "INSERT into clientes (id_usuario, nome, sobrenome, endereco, email, telefone) VALUES ('$dados[0]', '$dados[1]', 
		   '$dados[2]',
		   '$dados[3]',
			'$dados[4]',
			'$dados[5]'
	...
	public function obterDadosCliente($idcliente){
		...
		$sql = "SELECT id_cliente, nome, sobrenome, endereco, email, telefone 
	...
	public function atualizarCliente($dados){
		...
		endereco = '$dados[3]',email = '$dados[4]',telefone = '$dados[5]' where id_cliente = '$dados[0]'";
