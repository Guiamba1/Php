...
<div class="row">
	<div class="col-sm-4 ">
        ...
        <h4 class = "titulo">Vender Produtoz</h4>
			...
			<select class="form-control input-sm selecao1" id="produtoVenda" name="produtoVenda">
				<option value="A">Selecionar</option>
				<?php
			...
			<textarea readonly="" id="descricaoV" name="descricaoV" class="form-control input-sm selecao"></textarea>
			<label>Quantidade Estoque</label>
			<input readonly="" type="text" class="form-control input-sm selecao" id="quantidadeV" name="quantidadeV">
			<label>Preço</label>
			<input readonly="" type="text" class="form-control input-sm selecao" id="precoV" name="precoV">
			<label>Quantidade Vendida</label>
			<input type="text" class="form-control input-sm selecao" id="quantV" name="quantV">
			<p></p>
		...
		$('#produtoVenda').change(function(){
			...
			$.ajax({
				...
				success:function(r){
					...
					$('#quantidadeV').val(dado['quantidade']+ " Unidades disponiveis ");
		...
		$.ajax({
			...
			success:function(r){
				...
				if(r > 0){
					...
					alertify.alert("Venda efetuada com Sucesso!");
				}else if(r==0){
