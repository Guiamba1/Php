...
<!DOCTYPE html>
	...
	<body>
		<div class="container painelcli">
			<h1 class = "titulo">Painel de Gestao de Usuários</h1>
			<div class="row">
				<div class="col-sm-4 formulariocli">
					<form id="frmRegistro">
						<label>Nome</label>
		...
		$(document).ready(function(){
			$('#btnAtualizaUsuario').click(function(){
				...
				$.ajax({
					type:"POST",
					data:datos,
					url:"../procedimentos/usuarios/actualizarUsuario.php",
					success:function(r){
